...
<svg width="640" height="276" viewBox="0 0 640 276" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif">
  ...
  <rect x="36" y="138" width="48" height="48" rx="4" fill="#e09a3e" stroke="#7a531c" stroke-width="2"/>
  <text x="60" y="206" text-anchor="middle" fill="#e0b57a" font-size="12" font-weight="bold">Reactor</text>
  ...
  <rect x="280" y="138" width="48" height="48" rx="4" fill="#4f8fd0" stroke="#274a6b" stroke-width="2"/>
  <text x="304" y="206" text-anchor="middle" fill="#8fb6e0" font-size="12" font-weight="bold">Chamber</text>

  <rect x="216" y="58" width="40" height="40" rx="4" fill="#4f8fd0" stroke="#274a6b" stroke-width="2"/>
  <text x="266" y="83" fill="#8fb6e0" font-size="12" font-weight="bold">Chamber</text>
